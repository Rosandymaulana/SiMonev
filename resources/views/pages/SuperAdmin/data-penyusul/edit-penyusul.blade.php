            ...
            <div class="row">
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ url('super-admin/penyusul/'. $user->id_user) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" name="no_telp" class="form-control" id="no_telp" value="{{ $user->no_telp }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            @foreach($role as $data)
                            <input type="text" name="role" class="form-control" id="role" value="{{ $data->name }}" readonly disabled>
                            @endforeach
                        </div>
                    </div>
