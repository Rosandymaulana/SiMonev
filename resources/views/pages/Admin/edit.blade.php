        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">{{ $usulan->id }}</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ url('tabel_usulan/' .$usulan->id) }}" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="kelurahan" class="form-control" id="kelurahan"
                                            value="{{ $usulan->kelurahan }}" readonly disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="sub_kegiatan" class="form-control" id="sub_kegiatan"
                                            value="{{ $usulan->sub_kegiatan }}" readonly disabled />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="opd_tujuan_akhir" class="form-control"
                                            id="opd_tujuan_akhir" value="{{ $usulan->opd_tujuan_akhir }}" readonly
                                            disabled />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="koefisien" class="form-control" id="koefisien"
                                            value="{{ $usulan->koefisien }}" readonly disabled />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="nilai_akomodir" class="form-control"
                                            id="nilai_akomodir" value="{{ $usulan->nilai_akomodir }}" readonly
                                            disabled />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" name="tgl_pelaksanaan" class="form-control"
                                            id="tgl_pelaksanaan" value="{{ $usulan->tgl_pelaksanaan }}" />
                                    </div>
                                </div>
