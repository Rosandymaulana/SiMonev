                ...
                <div class="col-12">
                    <div class="card recent-sales overflow-auto mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <a href="{{ url('/admin/tabel-usulan') }}" class="btn btn-success">Back</a>
                            </div>
                            ...
                            <table class="table table-borderless datatable" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#">{{ $detail->kelurahan }}</a></th>
                                        <td class="text-primary">{{ $detail->no }}</td>
                                        <td>{{ $detail->sub_kegiatan }}</td>
                                        <td>{{ $detail->usulan }}</td>
                                        <td>{{ $detail->alamat }}</td>
                                        <td>{{ $detail->opd_tujuan_akhir }}</td>
